 ...
 * битовая маска часов). Оба слова (0x5100 и 0x5101) экран присылает ПАКЕТОМ
 * вместе с нажатием "Сохранить" (0x5062), а не при каждом отдельном
 * чекбоксе — живого обновления по каждому чекбоксу с экрана не происходит. */
